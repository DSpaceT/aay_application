...
class _ProfilePageState extends State<ProfilePage> {
                            ...
                            children: List.generate(
                              ...
                              (index) {
                                ...
                                Color textColor = Colors
                                    .white; // Change text color based on your requirements
                                ...
                                return Row(
                                  children: [
                                    ...
                                    SizedBox(
                                        width:
                                            10), // Adjust the spacing between the container and the icon button
                                    IconButton(
                                      icon: Icon(Icons.remove),
                                      onPressed: () {
                                        // Handle minus button tap
                                        _removeRewardFromFirestore(
                                            rewarddescriptions[index].id);
                                        setState(() {});
                                      },
                                      color: Colors
                                          .white, // Change the icon color based on your requirements
                                    ),
                                  ],
                                );
                              },
          ...
          Positioned.fill(
            child: Visibility(
              ...
              child: InfoOverlay(
                ...
                overlayImage:
                    overlaycoupon, //'assets/overlays/Profile_info_overlay.png',
              ),
            ),
          ),
        ],
  ...
  void toggleCouponOverlayVisibility(Reward reward) {
    ...
    setState(() {
      isOverlayVisiblecoupon =
          !isOverlayVisiblecoupon; //!isOverlayVisiblecoupon;
    });
  }
  ...
  Future<List<Coupon>> _getAllRewardsFromFirestore() async {
    ...
    if (userId.isNotEmpty) {
      ...
      fetchedCoupons =
          querySnapshot.docs.map((doc) => _rewardFromSnapshot(doc)).toList();
    }

    return fetchedCoupons;
  }

  Coupon _rewardFromSnapshot(
